  ...
  methods: {
    ...
    updateCategoryAsync() {
      return new Promise((resolve, reject) => {
        axios
          .put(
            `http://localhost:8001/api/category/${this.updateCatData.TICKET_CATEGORY_ID}`,
            this.updateCatData
          )
          .then(() => {
            this.tableKey += 1;
    ...
    deleteCategoryAsync() {
      return new Promise((resolve, reject) => {
        axios
          .delete(
            `http://localhost:8001/api/category/${this.deleteItem.itemId}`
          )
          .then(() => {
    ...
    addNewCategoryPromise() {
      return new Promise((resolve, reject) => {
        axios
          .post(`http://localhost:8001/api/category`, this.newCatDescrData)
          .then(() => {
            this.addCatCard = false;
            this.tableKey += 1;
            this.getCategories();
